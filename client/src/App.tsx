...
import FeedInvoices from "./pages/FeedInvoices";
import MillInvoices from "./pages/MillInvoices";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/invoicing/feed-invoices">
        <DashboardLayout>
          <FeedInvoices />
        </DashboardLayout>
      </Route>

      <Route path="/invoicing/mill-invoices">
        <DashboardLayout>
          <MillInvoices />
        </DashboardLayout>
      </Route>
