-- ============================================================
-- Feed Order Planning Module — Railway Database Migration
-- Run this script on your Railway MySQL database
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `feed_orders` (
  ...
  `quantityDeliveredTons` DECIMAL(10,3) NOT NULL DEFAULT 0,
  `orderDate` VARCHAR(20) NOT NULL,
  `requiredByDate` VARCHAR(20) NOT NULL,
  `transportType` ENUM('afgro_delivers','farm_collects') NOT NULL DEFAULT 'afgro_delivers',
  `transportCostPerTon` DECIMAL(10,2),
...
-- 2. Feed Order Deliveries (partial delivery support)
...
-- 3. Additive Purchase Orders (one per supplier per feed order)
