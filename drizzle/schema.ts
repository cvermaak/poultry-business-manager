...
export const invoices = mysqlTable("invoices", {
	...
	taxAmount: decimal({ precision: 12, scale: 2 }).notNull(),
	totalAmount: decimal({ precision: 12, scale: 2 }).notNull(),
	paidAmount: decimal({ precision: 12, scale: 2 }).default(0).notNull(),
	balanceDue: decimal({ precision: 12, scale: 2 }).notNull(),
